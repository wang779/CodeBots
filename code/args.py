...
def get_args():
    ...
    # dataset config
    parser.add_argument("--batch_size", type=int, default=64, help="the size of one mini-batch")
    ...
    parser.add_argument("--beam-size", type=int, default=3, help="the beam size of beam search")
